...
function App() 
{
    ...
    return (
        <Box>
            <Head>
                <title>Tweet Imaging - Create beautiful NFT-Images of Tweets</title>
            ...
            <footer>
                <Text px='1rem' className='i' color='gray.500' fontSize='lg'>Made with 💜  by <a href="https://www.twitter.com/mint__own" rel="noreferrer" target='_blank'>OWNly</a>. Check out on <a href="http://github.com/OWNly-Finance/tweet-imaging" rel="noreferrer" target='_blank'>Github</a>.</Text>
            </footer>
      </Box>
    )
